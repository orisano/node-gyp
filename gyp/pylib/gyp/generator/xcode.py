...
class XcodeProject(object):
  ...
  def Finalize1(self, xcode_targets, serialize_all_tests):
    ...
    for xck, xcv in py3compat.iteritems(self.build_file_dict.get('xcode_settings', {})):
    ...
    if build_file_configurations:
      for config_name in configurations:
        ...
        if build_file_configuration_named:
          ...
          for xck, xcv in py3compat.iteritems(build_file_configuration_named.get('xcode_settings', {})):
        ...
        if command.get('environment'):
          script = script + "\n".join(
            ['export %s="%s"' %
             ...
             for (key, val) in py3compat.iteritems(command.get('environment'))]) + "\n"
    ...
    for rule in spec_rules:
      ...
      if len(concrete_outputs_all) > 0:
        ...
        for concrete_output_index in \
            py3compat.xrange(0, len(concrete_outputs_by_rule_source)):
        ...
        for (rule_source, concrete_outputs, message, action) in \
          ...
          for concrete_output_index in py3compat.xrange(0, len(concrete_outputs)):
          ...
          for prerequisite_index in py3compat.xrange(0, len(prerequisites)):
...
""" % makefile_name
    ...
    for configuration_name in configuration_names:
      ...
      if 'xcode_settings' in configuration:
        for xck, xcv in py3compat.iteritems(configuration['xcode_settings']):
