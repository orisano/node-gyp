...
class XCObject(object):
  ...
  def Copy(self):
    ...
    for key, value in py3compat.iteritems(self._properties):
  ...
  def ComputeIDs(self, recursive=True, overwrite=True, seed_hash=None):
    ...
    if overwrite or self.id is None:
      ...
      id_ints = [0, 0, 0]
      for index in py3compat.xrange(0, digest_int_count):
  ...
  def Children(self):
    ...
    children = []
    for property, attributes in py3compat.iteritems(self._schema):
  ...
  def _XCPrintableValue(self, tabs, value, flatten_list=False):
    ...
    if isinstance(value, XCObject):
      ...
      printable = '{' + sep
      for item_key, item_value in sorted(py3compat.iteritems(value)):
        printable += element_tabs + \
  ...
  def UpdateProperties(self, properties, do_copy=False):
    ...
    for property, value in py3compat.iteritems(properties):
...
class XCFileLikeElement(XCHierarchicalElement):
  ...
  def PathHashables(self):
    ...
    while xche != None and isinstance(xche, XCHierarchicalElement):
      ...
      for index in py3compat.xrange(0, len(xche_hashables)):
...
class PBXNativeTarget(XCTarget):
  ...
  def HeadersPhase(self):
    ...
    if headers_phase is None:
      ...
      for index in py3compat.xrange(0, len(self._properties['buildPhases'])):
